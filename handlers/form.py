...
async def process_text(message: Message, state: FSMContext):
    ...
    # Сповіщаємо адмінів
    await notify_admins_new_request(message.bot, req_id, name, phone, text, "Telegram Bot")

async def notify_admins_new_request(bot, req_id: int, name: str, phone: str, text: str, source: str):
